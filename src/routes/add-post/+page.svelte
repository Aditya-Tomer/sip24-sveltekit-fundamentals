<script>
 ...
 <form class="container mx-auto p-5 card" method="POST" enctype="multipart/form-data">
    <div class="card-header">Upload and Edit Image</div>
    <div class="card-content">
        <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                {:else}
                    <svg class="w-8 h-8 mb-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="00 20 16"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/></svg>
        ...
        <div class="filter-buttons flex justify-between mb-1">
            <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-2 py-2.5 ml-2" on:click="{resetImage}">Reset</button>
            <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-2 py-2.5 ml-2" on:click="{() => applyFilter('blur')}">Blur</button>
            <button type="button" class="text-white bg-blue-500 hover:bg-blue-800 font-medium rounded-lg text-sm px-2 py-2.5 ml-2" on:click="{() => applyFilter('brightness')}">Brightness</button>
        </div>
    </div>
    <div class="card-content">
